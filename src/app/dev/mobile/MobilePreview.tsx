  ...
  return (
    <main style={{ padding: "24px 28px 60px", fontFamily: "var(--font-sans)" }}>
      ...
      >
        ...
        {/* Remounts every iframe. Hot reload already reaches inside them, but a
            change to something that only runs on load — the page loader, the
            header's falling objects — needs the load to happen again. */}
        <button
          type="button"
        ...
        <span style={{ fontSize: 12, opacity: 0.55 }}>
          {routes.length} routes at {device.w}×{device.h}
        </span>
      </header>
