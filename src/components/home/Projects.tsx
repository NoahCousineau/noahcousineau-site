    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="bg-white flex flex-col items-start text-left justify-center" style={{ width: `calc(var(--u) * ${BOX_WIDTH})`, height: `calc(var(--u) * ${BOX_HEIGHT})`, padding: `calc(var(--u) * 30)` }}>
          ...
          {/* Subtitle: fixed 30u italic serif, no variation */}
          <div className="italic lowercase mt-[calc(var(--u)*12)] text-left" style={{ fontFamily: "var(--font-serif)", fontSize: `calc(var(--u) * 30)`, width: `calc(var(--u) * ${BOX_WIDTH - 60})` }}>
            {cell.disciplines}
          </div>
        </div>
      </div>
